...
export const CTABanner = () => {
  return (
    <section className="bg-brand rounded-[20px] py-12 md:py-25 flex flex-col items-center text-center my-14.5">
        ...
        <div className="flex items-center mb-12 md:mb-25 w-full max-w-2xl">
          <div className="h-px flex-1 bg-feint" />
          <div className="flex gap-2 opacity-30">
            <div className="w-5 aspect-square bg-[url('/home-decor/secondary/star-black.svg')] bg-cover bg-center"></div>
            <div className="w-5 aspect-square bg-[url('/home-decor/secondary/star-black.svg')] bg-cover bg-center"></div>
            <div className="w-5 aspect-square bg-[url('/home-decor/secondary/star-black.svg')] bg-cover bg-center"></div>
          </div>
          <div className="h-px flex-1 bg-feint" />
